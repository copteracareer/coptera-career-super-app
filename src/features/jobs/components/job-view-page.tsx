...
function mapJobToFormValues(job: JobVacancy): JobVacancyFormValues {
  return {
    ...
    job_experience_id: job.jobExperience ? job.jobExperience.id : 0,
    job_classification_id: job.jobClassification ? job.jobClassification.id : 0,
    job_type_id: job.jobType ? job.jobType.id : 0,
    education_level_id: job.educationLevel ? job.educationLevel.id : 0,
